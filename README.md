...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/motifcluster-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14524&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/motifcluster-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `motifcluster` can be installed with:

```
conda install motifcluster
```

It is possible to list all of the versions of `motifcluster` available on your platform with:
